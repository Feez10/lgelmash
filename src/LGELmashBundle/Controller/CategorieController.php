...
use LGELmashBundle\Form\CategorieType;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LGELmashBundle:Categorie')->findAll();
     ...
     * @Method("POST")
     * @Template("LGELmashBundle:Categorie:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LGELmashBundle:Categorie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LGELmashBundle:Categorie:edit.html.twig")
     */
